...
public class LoginUserHandlerArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
		...
		// UserAuthenticationProvider.java 에서
		// new UsernamePasswordAuthenticationToken 등록시 첫번재 인자로 LoginUser설정함.
		// UsernamePasswordAuthenticationToken(Object principal, Object credentials, Collection<? extends GrantedAuthority> authorities) 구조임.
